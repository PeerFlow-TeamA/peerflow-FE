...
function QuestionListItem({ index, content}: { index: number, content: QuestionContent }): JSX.Element {
  ...
  return (
    <List>
      {contents.map((content) => (
        <QuestionListItem key={content.questionId} index={++index} content={content}/>
        ))}
      <Divider />
